    ...
    <div class="table">
        @if(isset($faqs))
            ...
            <div class="table-element">
                <ul class="table-data">
                    <li class="table-item">id: <span>{{$faq_element->id}}</span></li>
                    <li class="table-item">Nombre: <span>{{$faq_element->title}}</span></li>
                    <li class="table-item">Creado el: <span>{{$faq_element->created_at}}</span></li>
                </ul>
                <div class="table-buttons">
                    <svg class="edit-button" data-url="{{route('faqs_edit', ['faq' => $faq_element->id])}}" viewBox="0 0 24 24">
                    ...
                    <svg class="delete-button" data-url="{{route('faqs_destroy', ['faq' => $faq_element->id])}}" viewBox="0 0 24 24">
...
@section("form")
    @if(isset($faqs))
        <form action="{{route('faqs_store')}}" class="admin-form" id="form" autocomplete="off">    
            <div class="form-header">
                ...
                <div class="form-buttons">
                    ...
                    <svg id="clean-button" data-url="{{route('faqs_create')}}" viewBox="0 0 24 24">
            ...
            <div class="form-users tab-content is_active" data-tabcontent="contenido">
                ...
                <div class="form-item">
                    <input type="text" name="title" id="title" placeholder="Escribe título de faq" value="{{isset($faq->title) ? $faq->title : ''}}">
                </div>
                <div class="form-item">
                    <input type="text" name="question" id="question" placeholder="Escribe cuestión de faq" value="{{isset($faq->question) ? $faq->question : ''}}"> 
                </div>
                <div class="form-item">
                    <input type="text" name="answer" id="answer" placeholder="Escribe respuesta de faq" value="{{isset($faq->answer) ? $faq->answer : ''}}"> 
                </div>
            </div>
