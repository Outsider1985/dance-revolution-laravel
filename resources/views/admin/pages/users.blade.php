...
@section("content")
    <div class="admin-users-container">
        <div class="delete-warning">Va a eliminar este usuario. ¿Está seguro?</div>
        <div class="users-container">
            <div class="users-table">
                <div class="user-element">
                    ...
                    <div class="user-buttons">
                        <svg id="user-edit" style="width:24px;height:24px" viewBox="0 0 24 24">
                        ...
                        <svg id="user-delete" style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div class="users-page-navigator">
        ...
        <form class="form-container admin-form" id="user-form" action="/users/create" autocomplete="off">
                <div class="form-header">
                    ...
                    <div class="form-buttons">
                        ...
                        <svg id="clean-buttons" style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <div class="form-input tab-content is_active" data-tabcontent="contenido">
                    <div class="form-item">
