        ...
        <div class="table">
            @if(isset($users))
                ...
                <div class="table-element">
                    <ul class="table-data">
                        <li class="user-name">id: <span>{{$user->id}}</span></li>
                        <li class="user-name">Nombre: <span>{{$user->name}}</span></li>
                        <li class="user-name">Email: <span>{{$user->email}}</span></li>
                        <li class="user-created">Creado el: <span>{{$user->created_at}}</span></li>
                    </ul>
                    <div class="table-buttons">
                        <svg class="edit-button" data-url="{{route('users_edit', ['user' => $user->id])}}" viewBox="0 0 24 24">
                        ...
                        <svg class="delete-button" data-url="{{route('users_destroy', ['user' => $user->id])}}" viewBox="0 0 24 24">
        ...
        <form action="{{route('users_store')}}" class="admin-form" id="form" autocomplete="off">
                ...
                <div class="form-header">
                    ...
                    <div class="form-buttons">
                        <svg id="save-button" data-url="{{route('users_create')}}" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M15,9H5V5H15M12,19A3,3 0 0,1 9,16A3,3 0 0,1 12,13A3,3 0 0,1 15,16A3,3 0 0,1 12,19M17,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V7L17,3Z" />
                        </svg>
                        <svg id="clean-button" viewBox="0 0 24 24">
                ...
                <div class="form-users tab-content is_active" data-tabcontent="contenido">
                    ...
                    <div class="form-item">
                        <input type="email" name="email" id="email" placeholder="Escribe email de usuario"> 
                    </div>
                    <div class="form-item">
                        <input type="password" name="password" id="password" placeholder="Escribe clave de usuario">
                    </div>
                    <div class="form-item">
                        <input type="password" name="password-confirmation" id="password" placeholder="Escribe de nuevo clave de usuario">
                    </div>
                    {{--<div class="form-item">
                        <textarea type="text" name="description"  class="ckeditor" placeholder="Escribe funciones de usuario"></textarea>
                    </div>--}} 
                </div>
